...
async def test_get_accounts(client, authenticated_user):
    ...
    await client.post(
        "/accounts",
        json={"owner_name": "user2", "balance": 1000.0, "account_type": "checking"},
        headers=headers,
    )
...
async def test_account_ownership_privacy(client):
    ...
    await client.post(
        "/accounts",
        json={"owner_name": "User One", "balance": 1000.0, "account_type": "checking"},
        headers=headers1,
    )

    response = await client.get("/accounts", headers=headers2)
...
async def test_update_account_owner_name(client, authenticated_user):
    ...
    response = await client.put(
        f"/accounts/{account_id}", json={"owner_name": "new_user"}, headers=headers
    )
...
async def test_update_account_type(client, authenticated_user):
    ...
    response = await client.put(
        f"/accounts/{account_id}", json={"account_type": "savings"}, headers=headers
    )
...
async def test_update_account_frozen(client, authenticated_user):
    ...
    response = await client.put(
        f"/accounts/{account_id}", json={"frozen": True}, headers=headers
    )
...
async def test_delete_account(client, authenticated_user):
    ...
    # delete account
    delete_response = await client.delete(f"/accounts/{account_id}", headers=headers)
...
async def test_set_frozen_unfreeze(client, authenticated_user):
    ...
    response = await client.patch(
        f"/accounts/{account_id}/set_freeze", json={"freeze": False}, headers=headers
    )
